      ...
      body: Container(
        ...
        child: FutureBuilder(builder: (BuildContext context, AsyncSnapshot<DatabaseEvent> snapshot) {
          ...
          if(!snapshot.data!.snapshot.exists){
            ...
            for(int i=1 ; i<=12;i++){
              weekList.add(Expanded(child: Text('Month $i',textAlign: TextAlign.center,),),);
            }
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: averageDuration(firstList)*2,label: Text('Month 1'),topLabel: Text('${averageDuration(firstList)}'),),
                                if(secondList.isNotEmpty)Bar(height: averageDuration(secondList)*2,label: Text('Month 2'),topLabel: Text('${averageDuration(secondList)}'),),
                                if(thirdList.isNotEmpty)Bar(height: averageDuration(thirdList)*2,label: Text('Month 3'),topLabel: Text('${averageDuration(thirdList)}'),),
                              ],
                            ),
                          ),
                        ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: (getHeight(getNapData(firstList, 4)))*50,label: Text('Month 1'),topLabel: Text(getNapData(firstList,4),)),
                                if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList,4))*50,label: Text('Month 2'),topLabel: Text(getNapData(secondList,4),)),
                                if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(thirdList,4))*50,label: Text('Month 3'),topLabel: Text(getNapData(thirdList,4),)),
                              ],
                            ),
                          ),
                        ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: (getHeight(getNapData(firstList, 5)))*50,label: Text('Month 1'),topLabel: Text(getNapData(firstList,5),)),
                                if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 5))*50,label: Text('Month 2'),topLabel: Text(getNapData(secondList,5),)),
                                if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 5))*50,label: Text('Month 3'),topLabel: Text(getNapData(thirdList,5),)),
                              ],
                            ),
                          ),
                        ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: (getHeight(getNapData(firstList, 6)))*50,label: Text('Month 1'),topLabel: Column(
                                  children: [
                                ...
                                if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 6))*50,label: Text('Month 2'),topLabel: Column(
                                  children: [
                                ...
                                if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 6))*50,label: Text('Month 3'),topLabel: Column(
                                  children: [
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: (getHeight(getNapData(firstList, 7)))*50,label: Text('Month 1'),topLabel: Column(
                                  children: [
                                ...
                                if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 7))*50,label: Text('Month 2'),topLabel: Column(
                                  children: [
                                ...
                                if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 7))*50,label: Text('Month 3'),topLabel: Column(
                                  children: [
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(height: 300,),
                              Bar(height: (getHeight(getNapData(firstList, 8)))*50,label: Text('Month 1'),topLabel: getMoodData(firstList,8,),color: Colors.white,),
                              if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 8))*50,label: Text('Month 2'),topLabel: getMoodData(secondList,8,),color: Colors.white,),
                              if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 8))*50,label: Text('Month 3'),topLabel: getMoodData(thirdList,8,),color: Colors.white,),
                            ],
                          ),
                        ),
                      ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(height: 300,),
                                Bar(height: (getHeight(getNapData(firstList, 9)))*50,label: Text('Month 1'),topLabel: Column(
                                  children: [
                                ...
                                if(secondList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 9))*50,label: Text('Month 2'),topLabel: Column(
                                  children: [
                                ...
                                if(thirdList.isNotEmpty)Bar(height: getHeight(getNapData(secondList, 9))*50,label: Text('Month 3'),topLabel: Column(
                                  children: [
